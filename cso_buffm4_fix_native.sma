...
new V_MODEL[64] = "models/egoist/jb/weapon/v_buff_m4.mdl"
new P_MODEL[64] = "models/egoist/jb/weapon/p_buffm4.mdl"
...
{
	"sprites/egoist/jb/muzzleflash43.spr",
	"sprites/egoist/jb/muzzleflash44.spr",
	"sprites/egoist/jb/muzzleflash45.spr"
}

// You Can Add Fire Sound Here
new const Fire_Sounds[][] = { "weapons/egoist/jb/m4a1buff-1.wav", "weapons/egoist/jb/m4a1buff-2.wav" }
...
public plugin_precache()
{
	...
	Trail = precache_model("sprites/egoist/jb/zbeam2.spr")
...
public Weapon_ItemPostFrame(weapon_entity) 
{
	...
	new iBpAmmo = rg_get_user_bpammo(id, WEAPON_GALIL)
	...
	if(fInReload && flNextAttack <= 0.0)
	{
		...
		rg_set_user_bpammo(id, WEAPON_GALIL, iBpAmmo-j)
...
public give_item(id)
{
	...
	if(iWeapon > 0)
	{
		...
		rg_set_user_bpammo(id, WEAPON_GALIL, get_pcvar_num(cvar_ammo))
